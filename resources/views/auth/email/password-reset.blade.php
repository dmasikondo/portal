...
<head>
    ...
    <title>Welcome to Harare Polytechnic College</title>
    <style type="text/css">
        html {
            ...
            <td align="center" bgcolor="#eff3f8">
				...
				Item -->
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 17px; color: #4db3a4;">
						Hi {{strtoupper($user->name)}}, you requested a password reset. Click the link below to proceed,
                        if this was not your request, please ignore it.
					</span></span>
                                        </div>
                                        <!-- padding -->
                                ...
                                <tr>
									...
									<span style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
										This e-mail carries your reference for your Harare Polytechnic College
                                        Student Account Password Reset Link and as such is confidential. Below is the
                                        password reset link:<br/>
                                        <p><a target="_blank" href="{{$route}}">Reset Password Now</a></p>
                                ...
                                <tr>
                                    <td align="center">
                                        <div style="line-height:24px;">
                                            {{--<a href="{{route('confirm-reg',['code'=> $code])}}" target="_blank"--}}
                                            {{--style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">--}}
                                            {{--<font face="Arial, Helvetica, sans-seri; font-size: 13px;" size="3"--}}
                                            {{--color="#596167">--}}
                                            {{--<img src="{{URL::asset('assets/apps/img/confirm_button.PNG')}}"--}}
                                                ...
                                                <td align="center" valign="middle"
                                                    ...
                                                    <font face="Tahoma, Arial, Helvetica, sans-serif" size="2"
                                                        ...
                                                        <span style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #5b9bd1;">
                                                            You are receiving this email because you have a student account
                                                            on the Harare Polytechnic College Website. If you didn't
