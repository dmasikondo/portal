            ...
            <td align="center" bgcolor="#eff3f8">
				...
				Item -->
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 17px; color: #4db3a4;">
						Hi {{strtoupper($user->name)}}, this email is related to the support request you made on the Harare Polytechnic College Portal.
					</span></span>
                                        </div>
                                        <!-- padding -->
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <div style="line-height: 24px;">
                                                        <span style="font-size: 16px; font-family: Arial, Helvetica, sans-serif; font-size: medium; color: #57697e; ">
