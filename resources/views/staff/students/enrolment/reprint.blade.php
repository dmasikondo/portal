...
@section("pageTitle","Get Enrolled Student")

@section("headerTitle","Get Enrolled Student")
                ...
                <div class="card-content" id="programmeThing">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form form-horizontal form-bordered" method="post"
                              action="{{route('staff.students.get-enrolment.ps',["loc"=>"reprint"])}}">
                            {!! csrf_field() !!}
                            <div class="form-body">
