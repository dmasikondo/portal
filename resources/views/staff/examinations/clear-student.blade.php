...
@section("pageTitle","Examinations - Student Clearance")

@section("headerTitle","Examinations - Student Clearance")
                            ...
                            <div class="col-md-6 offset-md-3">
                                <form class="form form-horizontal form-bordered" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 label-control">Library</label>
                                            <div class="col-md-9 form-text text-center text-bold-700">
                                                No outstanding books or fines
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        {{--</button>--}}
                                        <a href="{{route('staff.examinations.search',["to"=>"clear-student"])}}"
                                           class="btn mb-2 btn-info btn-lg btn-block">Search For Another
                                            Student</a>
                                        <a href="{{route('staff.examinations.index')}}"
                                           class="btn mb-2 btn-secondary btn-lg btn-block">Back</a>
                                    </div>
                                </form>
